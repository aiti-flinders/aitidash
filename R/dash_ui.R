...
summary_ui <- function(...) {
  ...
  fluidPage(
    ...
    h2("Employment Insights"),
    fluidRow( 
      boxes_ui("jobkeeper_total", indicator = "Jobkeeper applications", plot = TRUE, footer = em("Data last updated: 2021-05-14")),
      boxes_ui("jobkeeper_proportion", indicator = "Jobkeeper proportion", plot = TRUE, footer = em("Data last updated: 2021-05-14")),

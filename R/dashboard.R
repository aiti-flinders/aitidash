dashboardUI <- function(id, data) {
  ...
  fluidPage(
    ...
    fluidRow( 
      boxes_ui("jobkeeper_total", plot = FALSE, footer = em("Data last updated: 2021-02-19")),
      boxes_ui("jobkeeper_proportion", plot = FALSE, footer = em("Data last updated: 2021-02-19")),
